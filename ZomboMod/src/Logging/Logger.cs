    ...
    public partial class Logger
    {
        ...
        public static void Log(string message, ConsoleColor color = ConsoleColor.White)
        {
            ...
            try
            {
                ...
                if ((assembly.StartsWith("Zombo.") || assembly == "Assembly-CSharp" || assembly == "UnityEngine") && stackTrace.FrameCount > 2)
                {
                    assembly = stackTrace.GetFrame(2).GetMethod().DeclaringType.Assembly.GetName().Name;
                }
                if (assembly == "" || assembly == typeof(Logger).Assembly.GetName().Name || assembly == lastAssembly || assembly.StartsWith("Zombo.") || assembly == "Assembly-CSharp" || assembly == "UnityEngine")
                {
                    assembly = "";
                }
                else
        ...
        public static void LogException(Exception ex,string message = null)
        {
            ...
            try
            {
                ...
                if (assembly.StartsWith("ZomboMod.") && stackTrace.FrameCount > 1)
                {
